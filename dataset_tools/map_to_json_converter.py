...
osu = open("C:/Users/Admin/Documents/GitHub/taiko-project/dataset_tools/DJ SIMON - 321STARS (Zelos) [Taiko Oni].osu",'rt').readlines()
out = {}
...
with open(out["metadata"]["Title"].strip()+'.json','w') as file:
